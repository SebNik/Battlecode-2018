...
# Run our code.
echo java -Xmx40m -classpath ./out/production/NiklasBot:../battlecode/java org.niklasabraham.Player
java -Xmx40m -classpath ./out/production/NiklasBot:../battlecode/java org.niklasabraham.Player
